...
import org.mangorage.mangoland.script.datatypes.ObjectVariableType;
...
public final class ScriptDataTypes {
    public static final DataType<byte[]> VARIABLE_TYPE = DataType.of(new byte[] { 0x2e, 0x2A, 0x77, 0x01 }, VariableType::new);
    public static final DataType<byte[]> OBJECT_VARIABLE_TYPE = DataType.of(new byte[] {0x2e, 0x2A, 0x77, 0x02 }, ObjectVariableType::new);
